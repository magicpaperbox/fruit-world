...
LEVEL_1_SPEC = LevelSpec(
    maps=[
        MapSpec(
            ...
            strawberry_bushes=[
                SpriteObjectSpec(365, 313, 120, "sprites/objects/bush_big.png"),
                SpriteObjectSpec(970, 500, 100, "sprites/objects/bush_small.png"),
                SpriteObjectSpec(165, 701, 100, "sprites/objects/bush_wide.png"),
            ],
            blueberry_bushes=[SpriteObjectSpec(1270, 706, 88, "sprites/objects/bush_big.png")],
        ...
        MapSpec(
            ...
            strawberry_bushes=[
                SpriteObjectSpec(770, 280, 86, "sprites/objects/bush_wide.png"),
                SpriteObjectSpec(245, 711, 82, "sprites/objects/bush_wide.png"),
            ],
            blueberry_bushes=[SpriteObjectSpec(1370, 706, 88, "sprites/objects/bush_wide.png")],
            npcs={},
            static_objects=[],
